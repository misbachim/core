...
class PerformanceLevelDao
{
    public function __construct(Requester $requester)
    {
        $this->requester = $requester;
        $this->table = 'performance_levels';
    }
    ...
    */
    public function getAllItem($companyId, $id) {
        return
        DB::table('performance_level_details')
            ->select(
                'id',
                'level',
                'description',
    ...
    */
    public function getOne($companyId)
    {
        ...
        ->select(
            ...
            'sync_with_review as synchronize'
        )
        ->where([
            ['tenant_id', $tenantId],
            ['company_id', $companyId]
    ...
    */
    public function saveItems($obj) {
        DB::table('performance_level_details')->insert($obj);
    }
