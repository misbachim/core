...
class CreateViewSubordinateListRequestLoan extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::statement("
            create view v_subordinate_req_loan as
                select worklists.id,
                    ...
                    loan_requests.created_at as start_date,
                    loan_requests.created_at as end_date,
                ...
                left join loan_requests on 
                loan_requests.id = worklists.request_id and
                loan_requests.tenant_id = worklists.tenant_id and 
                loan_requests.company_id = worklists.company_id
    ...
    {
        DB::statement('drop view v_subordinate_req_loan;');
    }
}
