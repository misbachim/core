...
class CreateViewSubordinateListTravelExpenses extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::statement("
            create view v_subordinate_req_trvx as
                select worklists.id,
                    ...
                    travel_expenses.created_at as start_date,
                    travel_expenses.created_at as end_date,
                ...
                worklists.lov_wfty = 'TRVX'
                left join travel_expenses on 
                travel_expenses.id = worklists.request_id and
                travel_expenses.tenant_id = worklists.tenant_id and 
                travel_expenses.company_id = worklists.company_id
    ...
    {
        DB::statement('drop view v_subordinate_req_trvx;');
    }
}
