...
class CreatetabelPisitionCompetencyList extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('position_competency_lists', function (Blueprint $table) {
             $table->integer('tenant_id');
            $table->integer('company_id');
            $table->increments('id');
            $table->integer('position_competency_id')->nullable(true);
    ...
    {
        Schema::dropIfExists('position_competency_lists');
    }
}
